...
Route::get('/hello/{var?}', function($variabel = "--"){
	return $variabel;
});
...
Route::get('/mahasiswa/tambah/route', function(){
        ...
        $mahasiswa->nama = 'Hanif Aulia';
        $mahasiswa->nim = '1515015012';
...
Route::get('ujidoensthave','RelationshipRebornController@ujidoesnthave');